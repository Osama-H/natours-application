      ...
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          return (0, _axios.default)({
            ...
            // get it from postam
            data: {
              // the data that we're seding along with the request in the body (that we need from user)
              email: email,
              password: password
            },
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: "PATCH",
            // we can write it in lowercase, but we prefer the uppercase
            url: url,
            data: data,
            withCredentials: true
          });
...
if (logoutBtn) {
  logoutBtn.addEventListener('click', function () {
    ...
    (0, _login.logout)(); // Make sure this is getting called
  });
}
